        ...
        <main>
            <div class="generator">
                <div class="formtitle">
                    ...
                    <div>
                        <p>
                            Tutaj możesz zmienić ilość towarów w sklepie, zaktualizować ich ceny, a także zarządzać
                            stanem
                            magazynowym.
                        ...
                        <button class="button" name="saveandclose" type="submit" form="manageWarehouse">Zapisz i
                            wyjdź</button>
                        ...
                        <table id="newProductTable">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="number" class="price" name="newProduct[price]" min="0" max="99"
                                        size="2" step="1" value="0">
                                    <span class="currency">
                                        zł
                                    </span>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="number" name="newProduct[sizes][amount][]" min="0" max="999" size="3"
                                        placeholder="Ilość">

                                </td>
                                <td>
                                    <button type="button" id="newSizeBtn" class="button"
                                        onclick="addNewSize(this)">Dodaj
                                        rozmiar</button>
                                </td>
                            </tr>
                        </table>
                    ...
                    if ($productType != $productTypeOld) {
                        ?>
                                    <input type="number" class="price"
                                        name="products[<?php echo $item['size_id']; ?>][price]" min="0" max="99"
                                        step="1" value="<?php echo $item['price']; ?>">
                                    <span class="currency">
                                        zł
                                    </span>
                                    <?php
                                ...
                                <td class="nowrapCell">
                                    <div class="plusMinusInput">
                                        ...
                                        <input readonly type="text"
                                            name="products[<?php echo $item['size_id']; ?>][in_store]"
                                            value="<?php echo $item['in_store']; ?>">
                                        <span class="minus 
						<?php
                            if ($item['in_store'] < 1) {
                                echo ' disabled';
						...
						<?php
							...
							" onclick="changeVal(this)">
                                ...
                                <td>
                                    <input class="inWarehouse" onchange="disablePlusMinus(this)" type="number"
                                        name="products[<?php echo $item['size_id']; ?>][in_warehouse]" min="0" max="999"
                                        value="<?php echo $item['in_warehouse']; ?>">
                                </td>
                                <td>
                                    <button type="submit" name="productToRemove" value="<?php echo $item['size_id']; ?>"
