<?php
	...
	*/
	...
	$sessionId = $_SESSION['saleSession'];
...
<body>
	...
	<div class="generator sprzedaz">
		...
		<div class="formtitle">
		<h1>Nowa sprzedaż (nr <?=$sessionId;?>)</h1>
		<div>Kwota sprzedaży: <?=$income;?>zł</div>
		
		<label><button class="button"><a href="./setSaleSession.php">Zakończ sprzedaż</a></button></label>
		</div>
