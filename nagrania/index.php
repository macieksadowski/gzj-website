...
<body>
	...
	?>
	<div class="title"><h1>Nagrania</h1></div>
	...
	<div class="records-content">
		<div class="records-description">
			<div class="records-name">
			<h3 style="margin-block-end:0">2020</h3>
			<h1 style="margin-block-start:0">Pałac Jaśminowy</h1>
			</div>
	...
	<div class="records-content">
		<div class="records-description">
			<div class="records-name">
			<h3 style="margin-block-end:0">2019</h3>
			<h1 style="margin-block-start:0">Orle Gniazdo</h1>
			</div>
			<div class="records-cover">
				<img src="<?=$orleCover?>">
			</div>
	...
	<div class="records-content">
		<div class="records-description">
			<div class="records-name">
				<h3 style="margin-block-end:0">2019</h3>
				<h1 style="margin-block-start:0">DASH</h1>
			</div>
			<div class="records-cover">
				<img src="<?=$dashCover?>">
			</div>
	...
	<div class="records-content">
		<div class="records-description">
			...
			<div class="records-name">
			<h3 style="margin-block-end:0">2018</h3>
			<h1 style="margin-block-start:0">Pretekst</h1>
			</div>
			<div class="records-cover">
				<img src="<?=$pretCover?>">
			</div>
