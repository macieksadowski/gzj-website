...
<article>
    <section>
        <div class="about-content">
            <div class="about-photo">
                <img src={{ asset('img/about/about(1).jpg') }}>
            </div>
    ...
    <section>
        <div class="about-content">
            <div class="about-photo">
                <img src={{ asset('img/about/about(2).jpg') }}>
            </div>
            <div class="about-text">
                <h1>Koncerty</h1>
                <p>
    ...
    <section>
        <div class="about-content">
            <div class="about-photo">
                <img src={{ asset('img/about/about(3).jpg') }}>
            </div>
            <div class="about-text">
                <h1>Live Session</h1>
                <p>
    ...
    <section>
        <div class="about-content">
            <div class="about-photo">
                <img src={{ asset('img/about/about(4).jpg') }}>
            </div>
            <div class="about-text" id="moreinfo">
                ...
                <a href="mailto:{{ $mail }}" id="about-contact">
                    <img src={{ asset('img/ico-mail.png') }}>
                    <span style="margin-top:10px;">
                        {{ $mail }}
                    </span>
                </a>
                <button class="button">
                    <a href="{{ $menuItems['Oferta'] }}">
                        Oferta koncertowa
                    </a>
                </button>
            </div>
